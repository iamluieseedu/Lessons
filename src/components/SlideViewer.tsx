...
export const SlideViewer: React.FC<SlideViewerProps> = ({ slide }) => {
  return (
    <div className="w-full max-w-6xl mx-auto px-2 sm:px-4 py-2 flex items-center justify-center">
      <div className="w-full min-h-[500px] md:min-h-0 md:aspect-widescreen bg-gradient-to-br from-white via-slate-50 to-white rounded-2xl shadow-xl border border-slate-200/80 overflow-hidden relative group flex flex-col justify-between">
